...
<body>
    ...
    <main>
        <section class="search_bar">
            <form method="post" action="search_product.php" class="input_container">
                <input type="text" name="search_box" class="search_input" placeholder="search here" maxlength="100"/>
                <button type="submit" name="search_btn" class="submit_input">Cari produk</button>
            </form>
        </section>
