...
<body>
    ...
    ?>
    <main>
        <p style="font-size: 20px; font-weight: 700; color: var(--hitam); text-align: center; margin-top: 20px;">Kategori Postingan</p>
        <section>
            ...
            ?>
                <form method="post" class="card_post">
                    ...
                    <a href="category.php?category=<?= $fetch_posts['category']; ?>" class="post-cat" style="margin-top: 5px; text-decoration:none; font-size:12px; color:var(--hijau)" >
