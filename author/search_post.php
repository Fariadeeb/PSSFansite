...
<body>
    ...
    ?>
    <section>
        <h2 class="title_view_post">Cari Postingan</h2>
        ...
        <div class="post_wrap">
            <?php
                if(isset($_POST['searchbar']) or isset($_POST['search_btn'])){
                $searchbar = $_POST['searchbar'];
                $select_posts = $conn->prepare("SELECT * FROM `posts` WHERE author_id = ? AND title LIKE '%{$searchbar}%'");
                ...
                <form action="" method="post">
                    ...
                    <div class="btn_wrap">
                        ...
                        <button type="submit" name="delete" class="delete_btn" onclick="return confirm('Hapus Postingan ini?');">Hapus</button>
                        <a href="read_posts.php?post_id=<?= $post_id; ?>" class="view_btn">Selengkapnya</a>
                    </div>
                </form>
            <?php
                }
